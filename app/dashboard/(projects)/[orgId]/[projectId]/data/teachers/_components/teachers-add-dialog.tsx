// app/dashboard/(projects)/[orgId]/[projectId]/data/teachers/_components/teachers-add-dialog.tsx
"use client"
...
interface TeachersAddDialogProps {
  open: boolean
...
export function TeachersAddDialog({
  open,
  onOpenChange,
  subjects,
  yearGroups,
  cycle,
}: TeachersAddDialogProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const updatedTeachers = [...versionData.data.teachers, newTeacher]
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-175 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new teacher for your timetable
          </DialogDescription>
        </DialogHeader>
