...
//     label: "Return to Org",
//     icon: Undo,
//     href: (orgId: string, projectId: string) => `/dashboard/${orgId}`,
//     exactMatch: false,
...
//   const getHrefWithVersion = (item: typeof navigationItems[0]) => {
//     const baseHref = item.href(orgId, projectId)
//     if (item.preserveVersion && version) {
//       return `${baseHref}?version=${version}`
//     }
//     return baseHref
//   }
...
//     <div 
//       className={cn(
//         "h-full border-r bg-white shrink-0 relative",
...
//                 size="icon"
//                 className="h-8 w-8"
//                 title={(!isHydrated || !isExpanded) ? "Sidebar options" : undefined}
//               >
...
// // Export navigation items for use in inner sidebar
...
// Export navigation sections for use in inner sidebar
